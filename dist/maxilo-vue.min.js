(function (global, factory) {
	...
	*/
	...
	var numberFloat = function numberFloat(v) {
	  var d = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
	  return _parseFloat$2(selfNumber(v).toFixed(d));
	};

	var selfNumber = function selfNumber(value) {
	...
	***************************************************************************** */
	...
	var utils$2 = function utils$1() {
	  ...
	  this.add = function (namespace, func) {
	    ...
	    var getKeys = keys$3(this.utilMap);

	    this.depNameSpace(this.utilMap, tmp, func, bind);

	    if (!includes$4(getKeys).call(getKeys, tmp[0])) {
	      defineProperty$7(this, tmp[0], {
	        get: function get() {
	          return _this3.utilMap[tmp[0]];
	        }
	      });
	    }
	  };
