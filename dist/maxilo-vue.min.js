(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.maxiloVue = factory());
	...
	*/
	...
	function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context7; forEach$2(_context7 = ownKeys$1(Object(source), true)).call(_context7, function (key) { defineProperty$5(target, key, source[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source)); } else { var _context8; forEach$2(_context8 = ownKeys$1(Object(source))).call(_context8, function (key) { defineProperty$7(target, key, getOwnPropertyDescriptor$3(source, key)); }); } } return target; }
	...
	var slotDeepClone = function slotDeepClone(vnodes, createElement) {
	  function cloneVNode(vnode) {
	    ...
	    var clonedChildren = vnode.children && map$2(_context2 = vnode.children).call(_context2, function (vnode) {
	  ...
	  var clonedVNodes = map$2(vnodes).call(vnodes, function (vnode) {
	    return cloneVNode(vnode);
	  });
	...
	var getSlot = function getSlot(target, i) {
	  ...
	  if (target === undefined || !isArray$3(target)) {
	    return '';
	  }

	  var s = filter$2(target).call(target, function (v) {
	    return v.tag;
	  })[i];
	...
	var bind$1 = function _bind(struct, data) {
	  ...
	  if (type == '[object Object]') {
	    ...
	    forEach$2(_context3 = keys$3(struct)).call(_context3, function (k) {
	...
	var cloneDeep = function _cloneDeep(data) {
	  ...
	  if (!includes$4(_context4 = ['[object Array]', '[object Object]']).call(_context4, type)) {
	    return data;
	  } else {
	    if (type == '[object Array]') {
	      ...
	      forEach$2(_context5 = keys$3(obj)).call(_context5, function (k) {
	...
	var has$2 = function has(obj, path) {
	  ...
	  for (var i = 0; i < x_len; i++) {
	    ...
	    if (!includes$4(_context6 = ['[object Array]', '[object Object]']).call(_context6, Object.prototype.toString.call(obj)) || !(v in obj)) {
	      if (failBack !== null) {
	        failBack(obj, slice$3(x).call(x, i));
	      }
	...
	var get$1 = function get(obj, path) {
	  var d = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
	  var value = has$2(obj, path, true, undefined);
	...
	var getType = function getType(o) {
	  ...
	  return slice$3(str).call(str, 8, str.length - 1);
	};
	...
	function router$1 () {
	  this.register = function (app) {
	    bind$5(app).call(app, "router", function (app) {
	      return new router();
	    });
	  };
	...
	var store$2 = function store() {
	  ...
	  this.run = function (store_key, debug) {
	    ...
	    this.instance = new index$1.Store({
	  ...
	  this.depModule = function (module, ds) {
	    ...
	    if (ds) {
	      ...
	      forEach$2(_context3 = keys$3(deps.state)).call(_context3, function (k) {
	        ...
	        if (utils.tool.isObject(deps.state[k]) || isArray$3(deps.state[k])) {
	          var _context4;

	          deps.state[k] = bind$5(_context4 = utils.tool).call(_context4, deps.state[k], ds[k] !== undefined ? ds[k] : {});
	        } else {
	...
	function store$3 () {
	  this.register = function (app) {
	    bind$5(app).call(app, "store", function (app) {
	      return new store$2();
	    });
	  };
	...
	var concat$1 = entryVirtual('Array').concat;

	var ArrayPrototype$9 = Array.prototype;

	var concat_1 = function (it) {
	  var own = it.concat;
	  return it === ArrayPrototype$9 || (it instanceof Array && own === ArrayPrototype$9.concat) ? concat$1 : own;
	};

	var concat$2 = concat_1;
	...
	function isPlainObject$1 (obj) {
	  return toString$3.call(obj) === OBJECT_STRING
	}
	...
	function parseArgs () {
	  ...
	  var params = null;
	  if (args.length === 1) {
	    if (isObject$4(args[0]) || Array.isArray(args[0])) {
	      params = args[0];
	    ...
	    /* istanbul ignore if */
	    if (isObject$4(args[1]) || Array.isArray(args[1])) {
	      params = args[1];
	    }
	  }
	...
	function update$1 (el, binding, vnode, oldVNode) {
	  ...
	  if (localeEqual(el, vnode) && looseEqual$1(binding.value, binding.oldValue)) { return }
	...
	function assert (el, vnode) {
	  var vm = vnode.context;
	  if (!vm) {
	    warn$1('not exist Vue instance in VNode context');
	    return false
	  }

	  if (!vm.$i18n) {
	    warn$1('not exist VueI18n instance in Vue instance');
	    return false
	  }
	...
	function t (el, binding, vnode) {
	  ...
	  if (!path && !locale && !args) {
	    warn$1('not support value type');
	    return
	  }

	  if (!path) {
	    warn$1('required `path` in v-t directive');
	    return
	  }
	...
	function install$2 (_Vue) {
	  ...
	  Object.defineProperty(Vue$2.prototype, '$i18n', {
	    get: function get () { return this._i18n }
	  });

	  extend$2(Vue$2);
	  Vue$2.mixin(mixin);
	  Vue$2.directive('t', { bind: bind$6, update: update$1, unbind: unbind });
	  Vue$2.component(component.name, component);
	...
	var prototypeAccessors$3 = { vm: { configurable: true },messages: { configurable: true },dateTimeFormats: { configurable: true },numberFormats: { configurable: true },locale: { configurable: true },fallbackLocale: { configurable: true },missing: { configurable: true },formatter: { configurable: true },silentTranslationWarn: { configurable: true } };
	...
	prototypeAccessors$3.vm.get = function () { return this._vm };

	prototypeAccessors$3.messages.get = function () { return looseClone(this._getMessages()) };
	prototypeAccessors$3.dateTimeFormats.get = function () { return looseClone(this._getDateTimeFormats()) };
	prototypeAccessors$3.numberFormats.get = function () { return looseClone(this._getNumberFormats()) };

	prototypeAccessors$3.locale.get = function () { return this._vm.locale };
	prototypeAccessors$3.locale.set = function (locale) {
	  this._vm.$set(this._vm, 'locale', locale);
	};

	prototypeAccessors$3.fallbackLocale.get = function () { return this._vm.fallbackLocale };
	prototypeAccessors$3.fallbackLocale.set = function (locale) {
	  this._vm.$set(this._vm, 'fallbackLocale', locale);
	};

	prototypeAccessors$3.missing.get = function () { return this._missing };
	prototypeAccessors$3.missing.set = function (handler) { this._missing = handler; };

	prototypeAccessors$3.formatter.get = function () { return this._formatter };
	prototypeAccessors$3.formatter.set = function (formatter) { this._formatter = formatter; };

	prototypeAccessors$3.silentTranslationWarn.get = function () { return this._silentTranslationWarn };
	prototypeAccessors$3.silentTranslationWarn.set = function (silent) { this._silentTranslationWarn = silent; };
	...
	VueI18n.prototype._interpolate = function _interpolate (
	  ...
	  if (Array.isArray(pathRet) || isPlainObject$1(pathRet)) { return pathRet }
	...
	VueI18n.prototype.mergeLocaleMessage = function mergeLocaleMessage (locale, message) {
	  this._vm.$set(this._vm.messages, locale, Vue$2.util.extend(this._vm.messages[locale] || {}, message));
	};
	...
	VueI18n.prototype.mergeDateTimeFormat = function mergeDateTimeFormat (locale, format) {
	  this._vm.$set(this._vm.dateTimeFormats, locale, Vue$2.util.extend(this._vm.dateTimeFormats[locale] || {}, format));
	};
	...
	VueI18n.prototype.mergeNumberFormat = function mergeNumberFormat (locale, format) {
	  this._vm.$set(this._vm.numberFormats, locale, Vue$2.util.extend(this._vm.numberFormats[locale] || {}, format));
	};
	...
	Object.defineProperties( VueI18n.prototype, prototypeAccessors$3 );
	...
	function i18n () {
	  this.register = function (app) {
	    bind$5(app).call(app, "i18n", function (app) {
	      return new VueI18n({
	      ...
	      get: function get() {
	        return function () {
	          ...
	          for (var i = 0; i < len; i++) {
	            ...
	            msg += isArray$3(tmp[i]) ? this.$t.apply(this, concat$3(_context = [tmp[i][0]]).call(_context, toConsumableArray(slice$3(_context2 = tmp[i]).call(_context2, 1, -1)))) : this.$t(tmp[i]);
	          }
	...
	***************************************************************************** */
	...
	function isEqual(lhs, rhs) {
	    ...
	    if (isObject$5(lhs) && isObject$5(rhs)) {
	...
	function _getRuleTargets(field, ruleSchema, ruleName) {
	    ...
	    if (!Array.isArray(ruleConfig) && isObject$5(ruleConfig)) {
	...
	function findModel(vnode) {
	    ...
	    return find$1(vnode.data.directives, function (d) { return d.name === 'model'; });
	}
	...
	function normalizeChildren$1(context, slotProps) {
	...
	var ValidationProvider = Vue.extend({
	    ...
	    render: function (h) {
	        ...
	        var children = normalizeChildren$1(this, ctx);
	...
	var ValidationObserver = Vue.extend({
	    ...
	    render: function (h) {
	        var children = normalizeChildren$1(this, prepareSlotProps(this));
	...
	var validator$1 = function validator() {
	  ...
	  this.run = function (app) {
	    ...
	    forEach$2(_context2 = keys$3(this.rules)).call(_context2, function (k) {
	      return extend$3(k, _this2.rules[k]);
	    });

	    forEach$2(_context3 = keys$3(this.messages)).call(_context3, function (k) {
	      return localize(k, {
	        name: k,
	...
	function validator$2 () {
	  this.register = function (app) {
	    bind$5(app).call(app, "validator", function (app) {
	...
	var bind$7 = function bind(fn, thisArg) {
	...
	function createInstance(defaultConfig) {
	  ...
	  var instance = bind$7(Axios_1.prototype.request, context);
	...
	function http () {
	  this.register = function (app) {
	    bind$5(app).call(app, "http", function (app) {
	...
	function config$2 () {
	  this.register = function (app) {
	    bind$5(app).call(app, "config", function () {
	      return new config$1();
	    });
	  };
	...
	var utils$2 = function utils$1() {
	  ...
	  this.depBind = function (hi) {
	    ...
	    forEach$2(_context = keys$3(hi)).call(_context, function (v) {
	      if (utils.tool.getType(hi[v]) == 'Object') {
	        ...
	        tmp[v] = bind$5(_context2 = function _context2() {
	          var _hi$v, _context3;

	          return (_hi$v = hi[v]).call.apply(_hi$v, concat$3(_context3 = [this]).call(_context3, slice$3(Array.prototype).call(arguments)));
	    ...
	    if (tmp.length == 1 && !this.utilMap[tmp[0]]) {
	      ...
	      defineProperty$7(this, k, {
	        get: function get() {
	          ...
	          return bind ? bind$5(_context5 = function _context5() {
	            var _this$utilMap$k, _context6;

	            return (_this$utilMap$k = this.utilMap[k]).call.apply(_this$utilMap$k, concat$3(_context6 = [this]).call(_context6, slice$3(Array.prototype).call(arguments)));
	  ...
	  this.depNameSpace = function (target, space, func) {
	    ...
	    if (len === 1) {
	      ...
	      target[space[0]] = bind ? bind$5(_context7 = function _context7() {
	        var _context8;

	        return func.call.apply(func, concat$3(_context8 = [this]).call(_context8, slice$3(Array.prototype).call(arguments)));
	      ...
	      this.depNameSpace(target[space[0]], slice$3(space).call(space, 1, len), func, bind);
	    }
	  };
	};
	...
	function utilsClass () {
	  this.register = function (app) {
	    bind$5(app).call(app, "utils", function (app) {
	      return new utils$2();
	    });
	  };
	...
	function vue$1 () {
	  this.register = function (app) {
	    bind$5(app).call(app, "vue", function (app) {
	      return new vue();
	    });
	  };
	...
	try {
	  maxiloVueModule.register(new config$2());
