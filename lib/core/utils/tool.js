...
var parseURL = function parseURL(url) {
  ...
  var tmp = {};
  (0, _forEach.default)(_context = url.replace(/^.*?\?/, '').split('&')).call(_context, function (v) {
    var t = v.split('=');
    tmp[t[0]] = t[1] ? t[1] : '';
  });
  return tmp;
...
var slotDeepClone = function slotDeepClone(vnodes, createElement) {
  function cloneVNode(vnode) {
    ...
    var clonedChildren = vnode.children && (0, _map.default)(_context3 = vnode.children).call(_context3, function (vnode) {
  ...
  var clonedVNodes = (0, _map.default)(vnodes).call(vnodes, function (vnode) {
    return cloneVNode(vnode);
  });
  return clonedVNodes;
};
...
var getSlot = function getSlot(target, i) {
  ...
  if (target === undefined || !(0, _isArray.default)(target)) {
    return '';
  }

  var s = (0, _filter.default)(target).call(target, function (v) {
    return v.tag;
  })[i];
