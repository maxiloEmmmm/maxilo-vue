...
var lvErr = function lvErr(err, level) {
	...
	Object.keys(err.data.errors).map(function (t) {
...
var hotAsset = function () {
	var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee2(assets) {
		var _this = this;
