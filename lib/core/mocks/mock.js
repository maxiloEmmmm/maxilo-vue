  ...
  return (
    ...
    function (module, exports, __webpack_require__) {
      ...
      */
      ...
      Mock.mock = function (rurl, rtype, template, title = false, check = null) {
        // Mock.mock(template)
    ...
    function (module, exports) {
      ...
      */
      var DICT = {
        ...
        "820200": "离岛",
        "990000": "海外",
        "990100": "海外" // id pid/parentId name children
    ...
    function (module, exports, __webpack_require__) {
      ...
      */
      ...
      var Handler = {
        extend: Util.extend // http://en.wikipedia.org/wiki/ASCII#ASCII_printable_code_chart
    ...
    function (module, exports, __webpack_require__) {
       ...
       */
      var Util = __webpack_require__(3); // 备份原生 XMLHttpRequest
      ...
      */
      ...
      Util.extend(MockXMLHttpRequest.prototype, {
        ...
        open: function (method, url, async, username, password) {
          ...
          console.group && console.groupEnd(); // 如果未找到匹配的数据模板，则采用原生 XHR 发送请求。
        ...
        send: function send(data) {
          var item = this.custom.template; //todo check
          // if(item.check && item.check) {
          //   if(!item.check(data)) {
          //     console.log('| %c%s - 请求参数不足: %o', 'color:red', item.title, data);
          //     return ;
          //   }
          // }
